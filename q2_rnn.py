...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        while len(padded_sentence) < max_length:
            padded_sentence.append(zero_vector)
            padded_labels.append(zero_label)
        true_length = min(len(sentence), max_length)
        mask = [True] * true_length + [False] * (max_length - true_length)
...
class RNNModel(NERModel):
    ...
    def add_prediction_op(self):
        ...
        preds = tf.stack(preds) # T x None x n_classes
